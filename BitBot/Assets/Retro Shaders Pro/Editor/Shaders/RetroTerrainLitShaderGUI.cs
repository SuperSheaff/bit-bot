...
namespace RetroShadersPro.URP
{
    internal class RetroTerrainLitShaderGUI : ShaderGUI, ITerrainLayerCustomUI
    {
        ...
        const string kResolutionLimit = "_ResolutionLimit";

        MaterialProperty snapsPerUnit = null;
        const string kSnapsPerUnit = "_SnapsPerUnit";

        MaterialProperty colorBitDepth = null;
        const string kColorBitDepth = "_ColorBitDepth";

        MaterialProperty colorBitDepthOffset = null;
        const string kColorBitDepthOffset = "_ColorBitDepthOffset";
        ...
        protected void FindMaterialProperties(MaterialProperty[] props)
        {
            ...
            resolutionLimit = FindProperty(kResolutionLimit, props, false);
            snapsPerUnit = FindProperty(kSnapsPerUnit, props, false);
            colorBitDepth = FindProperty(kColorBitDepth, props, false);
            colorBitDepthOffset = FindProperty(kColorBitDepthOffset, props, false);
        ...
        public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
        {
            ...
            EditorGUI.indentLevel++;
            materialEditorIn.ShaderProperty(resolutionLimit, kResolutionLimit);
            materialEditorIn.ShaderProperty(snapsPerUnit, kSnapsPerUnit);
            materialEditorIn.ShaderProperty(colorBitDepth, kColorBitDepth);
            materialEditorIn.ShaderProperty(colorBitDepthOffset, kColorBitDepthOffset);
            EditorGUI.indentLevel--;
